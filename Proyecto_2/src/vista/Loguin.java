...
public class Loguin extends javax.swing.JFrame {
 Date fecha = new Date();
    ...
    private void initComponents() {
        ...
        Et_año.setText("Año");
        jPanel3.add(Et_año, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 100, 60, 20));

        Et_Mes.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        Et_Mes.setForeground(new java.awt.Color(240, 240, 240));
        Et_Mes.setText("MES");
        jPanel3.add(Et_Mes, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, 150, 50));
